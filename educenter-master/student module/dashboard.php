...
{
  $row=$student_details->fetch_assoc();
      ...
      <div class="row no-gutters">
        ...
        <img src="<?php echo $Profile; ?>" alt="Profile" class="rounded-circle" style="width: 35px; height: 35px; object-fit: cover;" title="Go to Profile">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="../student module/profile.php">My Profile</a>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="../student module/dashboard.php">Student Dashboard</a></li>
          <li class="list-inline-item text-white h3 font-secondary "></li>
        </ul>
        <p class="text-lighten"> Welcome to your academic hub — track your progress, manage your profile, register for courses, and stay updated with everything you need in one place.</p>
      </div>
    </div>
  </div>
</section>
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../student module/profile.php">
                  <i class="ti-user mr-1 text-color"></i> Profile
                </a>
              </li>
            </ul>
            <a href="../student module/profile.php">
              <h4 class="card-title">Student Profile</h4>
            </a>
            <p class="card-text mb-4">
              Access and manage your personal, academic, and account details in one place.
              Keep your information up-to-date and ensure your student record is accurate and secure.
            </p>
            <a href="../student module/profile.php" class="btn btn-primary btn-sm">Profile</a>
          </div>
        </div>
      </div>
      <!-- Profile End -->
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../fees/studentfees.php">
                  <i class="ti-wallet mr-1 text-color"></i> Fees
                </a>
              </li>
            </ul>
            <a href="../fees/studentfees.php">
              <h4 class="card-title">Fees</h4>
            </a>
            <p class="card-text mb-4"> Invest in your future with a clear, student-friendly fee structure
              designed to support your academic and career goals.</p>
            <a href="../fees/studentfees.php" class="btn btn-primary btn-sm">Pay Fees</a>
          </div>
        </div>
      </div>
      <!-- Fees End -->
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../result/result_display.php">
                  <i class="ti-pie-chart mr-1 text-color"></i> Result
                </a>
              </li>
            </ul>
            <a href="../result/result_display.php">
              <h4 class="card-title">Result</h4>
            </a>
            <p class="card-text mb-4"> Track your academic progress with ease — our result system ensures timely,
              transparent, and accurate performance updates to help you stay on top of your goals.</p>
            <a href="../result/result_display.php" class="btn btn-primary btn-sm">Result Details</a>
          </div>
        </div>
      </div>
      <!-- Result End -->
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../teacher.php">
                  <i class="ti-blackboard mr-1 text-color"></i> Teachers
                </a>
              </li>
            </ul>
            <a href="../teacher.php">
            ...
            <p class="card-text mb-4"> Get to know your mentors — explore detailed faculty profiles to
              connect with the educators guiding your academic journey.</p>

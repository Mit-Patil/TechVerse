    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          ...
          <li class="list-inline-item text-white h3 font-secondary nasted">M.Sc.(IT)</li>
        </ul>
        <p class="text-lighten">MSc IT stands for Master of Science in Information Technology.
             It’s a postgraduate degree program that focuses on advanced studies in computer science and IT-related subjects.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="images/courses/mscit.png" class="img-fluid w-100">
      </div>
    </div>
    <!-- course info -->
          ...
          <li class="list-inline-item mr-4 mb-3 mb-sm-0">
            <div class="d-flex align-items-center">
              ...
              <div class="text-left">
                ...
                <p class="mb-0">From: INR 25,000(per semester)</p>
              </div>
            </div>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p>MSc(IT), or Master of Science in Information Technology, is a postgraduate degree program designed to provide students with advanced knowledge and
             practical skills in the field of information technology. The course typically spans two years and covers a wide range of subjects,
              including programming, data structures, database management, networking, cybersecurity, software engineering, and web technologies.
               It is aimed at preparing students for technical and managerial roles in the IT industry by focusing on both theoretical foundations and
                real-world applications. MScIT is ideal for graduates who have a background in computer science, information technology, or related fields
                 and wish to deepen their expertise to pursue careers as software developers, IT consultants, data analysts, system administrators, or
                  other roles in the ever-evolving tech sector. The program also lays a strong foundation for those interested in research or further
                   academic pursuits such as a Ph.D. in computer science or related disciplines.</p>
      </div>
      <div class="col-12 mb-4">
          ...
          <div class="row">
            <div class="col-md-6">
              <ul class="list-styled">
                ...
                <li>Candidates requires a minimum of 45–50% aggregate marks in 12th standard and in Bachelors degree.</li>
      ...
      <div class="col-12 mb-5">
        ...
        <p>Fees(per semester) : INR 25,000 </p>
        <p>One-time Admission Fee : INR 1,500 </p>
        <p>Total Fees(2 years) : INR 1,01,500 </p>
      </div>

    ...
    <div class="row" data-ref="mixitup-container">
      ...
      <div data-ref="mixitup-target" class="col-lg-4 col-sm-6 mb-5 arts law">
        <div class="card border-0 rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="../educenter-master<?php echo $row['Profile'] ? $row['Profile'] : 'images/teachers/default.jpg'; ?>" alt="teacher">
      <div class="card-body">
          <div class="card-body">
            <a href="teacher-single.php?id=<?php echo $row['FacultyID']; ?>">

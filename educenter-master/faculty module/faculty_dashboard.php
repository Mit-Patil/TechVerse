...
$sql_faculty="SELECT * FROM $table WHERE Email='$email'";
$faculty_details=$conn->query($sql_faculty);

if($faculty_details->num_rows===1)
{
  $row=$faculty_details->fetch_assoc();
      ...
      <div class="row no-gutters">
        ...
        <img src="<?php echo $Profile; ?>" alt="Profile" class="rounded-circle" style="width: 35px; height: 35px; object-fit: cover;" title="Go to Profile">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="../faculty module/faculty_profile.php">My Profile</a>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="../faculty module/faculty_dashboard.php">Faculty Dashboard</a></li>
          <li class="list-inline-item text-white h3 font-secondary "></li>
        </ul>
        <p class="text-lighten">Simplify your teaching experience — access tools, manage tasks, and support student success from a single, intuitive dashboard.</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="../images/courses/bscit.png" alt="Faculty Profile">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../faculty module/faculty_profile.php"><i class="ti-id-badge mr-1 text-color"></i></a>
              </li>
              <li class="list-inline-item"><a class="text-color" href="../faculty module/faculty_profile.php">Profile</a></li>
            </ul>
            <a href="../faculty module/faculty_profile.php">
              <h4 class="card-title">Faculty Profile</h4>
            </a>
            <p class="card-text mb-4">Manage and update your academic identity — your hub for professional and teaching information.</p>
            <a href="../faculty module/faculty_profile.php" class="btn btn-primary btn-sm">Profile</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="../images/courses/mscit.png" alt="Result Creation">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../result/create_result.php"><i class="ti-bar-chart-alt mr-1 text-color"></i></a>
              </li>
              <li class="list-inline-item"><a class="text-color" href="../result/create_result.php">Result</a></li>
            </ul>
            <a href="../result/create_result.php">
              <h4 class="card-title">Generate Result</h4>
            </a>
            <p class="card-text mb-4">Create, update, and manage student results seamlessly with a streamlined grading system.</p>
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="../images/courses/mscict.png" alt="Student Details">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../student.php"><i class="ti-agenda mr-1 text-color"></i></a>
              </li>
            ...
            <p class="card-text mb-4">Access and review student records — support their academic growth through real-time insights.</p>
            <a href="../student.php" class="btn btn-primary btn-sm">Student Details</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="../images/courses/mscict.png" alt="Create Notice">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item">
                <a class="text-color" href="../admin/create_notice.php"><i class="ti-announcement mr-1 text-color"></i></a>
              </li>
              <li class="list-inline-item"><a class="text-color" href="../admin/create_notice.php">New Notice</a></li>
            </ul>
            <a href="../admin/create_notice.php">
              <h4 class="card-title">Notices</h4>
            </a>
            <p class="card-text mb-4">Post important announcements and stay connected with students through timely updates.</p>

    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="../educenter-master/student.php">Our Students</a></li>
          <li class="list-inline-item text-white h3 font-secondary @@nasted"></li>
        </ul>
        <p class="text-lighten">Where every lesson shapes the future—our students are tomorrow’s leaders in the making.</p>
        </div>
    </div>
  </div>
</section>
    ...
    <div class="row" data-ref="mixitup-container">
      ...
      <div data-ref="mixitup-target" class="col-lg-4 col-sm-6 mb-5 arts law">
        <div class="card border-0 rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="../educenter-master<?php echo $row['Profile'] ? $row['Profile'] : 'images/teachers/default.jpg'; ?>" alt="Student">
      <div class="card-body">
          <div class="card-body">
            <a href="student-single.php?id=<?php echo $row['StudentID']; ?>">

    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          ...
          <li class="list-inline-item text-white h3 font-secondary nasted">B.Sc.(IT)</li>
        </ul>
        <p class="text-lighten">BSc IT (Bachelor of Science in Information Technology) is a three-year undergraduate program that focuses on the study of computer systems, software development, networking, databases, and information security.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="images/courses/bscit.png" class="img-fluid w-100">
      </div>
    </div>
    <!-- course info -->
          ...
          <li class="list-inline-item mr-4 mb-3 mb-sm-0">
            <div class="d-flex align-items-center">
              ...
              <div class="text-left">
                ...
                <p class="mb-0">From: INR 22,000(per semester)</p>
              </div>
            </div>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p>'Bachelor of Science in Information Technology (BSc IT)' is a three-year undergraduate program designed to provide students with a strong foundation in the field of information technology. The course covers key areas such as programming, data structures, database management, networking, web development, operating systems, and information security.
             It aims to equip students with both theoretical knowledge and practical skills needed to solve real-world IT problems.
             BSc IT graduates gain expertise in software development, system analysis, and IT infrastructure management, making them well-suited for careers as software developers, web developers, system analysts, network administrators, and more.
              The program also serves as a stepping stone for higher studies like MSc IT or MCA, and offers opportunities to pursue professional certifications in cloud computing, cybersecurity, and networking. With the ever-growing demand for IT professionals,
               BSc IT opens the door to diverse and rewarding career paths in the tech industry.</p>
      </div>
      <div class="col-12 mb-4">
          ...
          <div class="row">
            <div class="col-md-6">
              <ul class="list-styled">
                ...
                <li>Candidates requires a minimum of 45–50% aggregate marks in 12th standard.</li>
                <li>Candidates age must be between 17 and 25 at the time of admission.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-12 mb-4">
        ...
        <ul class="list-styled">
          ...
          <li>Wait for the merit list based on 12th percentage.</li>
        </ul>
      </div>
      <div class="col-12 mb-5">
        <h3>Fees and Funding</h3>
        <p>Fees(per semester) : INR 22,000 </p>
        <p>One-time Admission Fee : INR 1,500 </p>
        <p>Total Fees(3 years) : INR 1,33,500 </p>
      </div>
      <!-- teacher -->
      <div class="col-12">
